...
import { normalizeAuthField } from '../utils/helpers'
            ...
            <div className="flex items-center gap-3">
                <div className="text-right hidden sm:block">
                    <p className="text-sm font-medium text-slate-200">
                        {normalizeAuthField(user?.username) || 'User'}
                    </p>
                    <p className="text-xs text-slate-400">{normalizeAuthField(user?.role) || 'user'}</p>
                </div>
